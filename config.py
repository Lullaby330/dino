...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6786689552:AAHQeMrwKYqPGBCjQESKlHLX1R_J1tCws2k")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002039819289"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1850233338"))

#Port
PORT = os.environ.get("PORT", "6895")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002019691579"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "6634814433 6934554097").split()):
        ADMINS.append(int(x))
except ValueError:
